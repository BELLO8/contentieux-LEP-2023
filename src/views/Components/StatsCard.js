...
import { TrendingUp, User, Box, DollarSign, UserPlus, Users, Percent, Archive, MapPin, Check, CheckCircle } from 'react-feather'
...
import { nombreBV, nombreElecteur, nombreLV, nombreVotant, nombreVotantGlobal } from '../../redux/store/Election'
...
const StatsCard = ({ cols }) => {
  ...
  const data = [
    ...
    },
    {
      ...
      subtitle: 'Nombre d\'inscrit sur la liste',
      color: 'light-success',
      icon: <User size={24} />
    },
    {
  ...
  return (
    <Card className='card-statistics'>
      <CardHeader>
        <CardTitle tag='h4'>Statistics globale</CardTitle>
      </CardHeader>
