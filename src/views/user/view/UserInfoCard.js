      ...
      <Card>
        <CardBody>
          <div className='user-avatar-section'>
            ...
            <Avatar color='light-danger' content='Galen Slixby' initials size='xl' />
            </div>
          </div>
          <div className='info-container'>
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Nom du candidat:</span>
                  <span>{selectedUser.username}</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Email du candidat:</span>
